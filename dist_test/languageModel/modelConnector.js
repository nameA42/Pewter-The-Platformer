...
async function initializeLLM(chatMessageHistory) {
  //inject sys prompt
  chatMessageHistory.push(new messages_1.SystemMessage(sysPrompt));
}
...
//   }
// }
async function getChatResponse(chatMessageHistory) {
  if (!llmWithTools) {
    throw new Error(
