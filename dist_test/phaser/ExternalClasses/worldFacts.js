...
exports.WorldFacts =
  exports.EnemyFact =
  exports.CollectableFact =
  exports.StructureFact =
  exports.Fact =
    void 0;
class Fact {
  constructor(key, category, description) {
    this.key = key;
...
exports.Fact = Fact;
class StructureFact extends Fact {
  constructor(xStart, xEnd, structureType, heightsOrHeight) {
    super(
...
exports.StructureFact = StructureFact;
class CollectableFact extends Fact {
...
exports.CollectableFact = CollectableFact;
class EnemyFact extends Fact {
...
class WorldFacts {
  ...
  extractStructures(scene) {
    ...
    const columnTop = new Array(width).fill(-1);
    ...
    const columnBottoms = new Array(width).fill(-1);
    for (let x = 0; x < width; x++) {
      let b = -1;
